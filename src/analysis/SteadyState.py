...
def get_steady_files(file):

    if not os.path.exists(file):
        return "Not found the %s file" %file
    ...
    parser.add_argument("-f", "--input_file", default=file,
                        help='Full name of the input file (default %s). File format is | frame | rho | velocity |' % file)
