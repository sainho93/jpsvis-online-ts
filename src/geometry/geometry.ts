...
import {Geo} from './initialization'
import {LAND} from './materials'
import {flatRectMesh} from './utils'
...
export function makeStaticObjects(
	...
	// Land mesh
	const bgMesh = flatRectMesh(size, LAND);
	bgMesh.name = 'Land';
	bgMesh.receiveShadow = true;
	group.add(bgMesh);

	console.log('Loadad gound plane');
